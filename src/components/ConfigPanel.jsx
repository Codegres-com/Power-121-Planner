...
import { Settings, Calendar, Key, ChevronDown, ChevronUp, Clock, Type, Users } from 'lucide-react';
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="animate-fade-in">
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Group Size (People per meeting)</label>
                        <div className="relative group">
                        ...
                        <p className="text-xs text-gray-400 mt-1">Default: 2 (Pairs)</p>
                    </div>
                </div>
            </div>
        </div>
